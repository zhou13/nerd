"""
Hourglass network with inplace pre-activated Bottleneck structures
(c) Yichao Zhou (SymmetryNet)
...
class HourglassNet(nn.Module):
    def __init__(self, planes, block, head, inv_head, depth, num_stacks, num_blocks):
